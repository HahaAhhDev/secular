 ...
 */
import { getMeta, categoryLabel } from "./meta.js";
...
export function evaluate(ctx) {
    ...
    const attributionNeeded = [...ctx.thirdParty.keys()].filter((id) => ["MIT", "ISC", "BSD-2-Clause", "BSD-3-Clause", "Apache-2.0", "Zlib", "BSL-1.0"].includes(id));
