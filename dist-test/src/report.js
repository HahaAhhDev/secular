...
export function toJson(r) {
    return JSON.stringify({
        ...
        thirdPartyLicenses: Object.fromEntries([...r.thirdParty.entries()].map(([id, v]) => [id, { category: v.category, files: v.files }])),
